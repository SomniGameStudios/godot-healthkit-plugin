# A Godot IOSBridgePlugin for health kit and other iOS native integrations

## Native integrations

1. HealthKit
2. App tracking authorization
...
- This is a plugin that allows you to request user permission to track their activity.
